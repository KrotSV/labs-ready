...
public class JdbcTest {
  ...
  @Test
  public void testGetCountryByName() throws CountryNotFoundException {
    Country expectedCountry = expectedCountryList.get(0);
    Country actualCountry = countryDao.getCountryByName(expectedCountry.getName());

    assertEquals(expectedCountry, actualCountry);
  }

  @Test
  public void testGetCountryByCodeName() throws CountryNotFoundException {
    Country expectedCountry = expectedCountryList.get(0);
    Country actualCountry = countryDao.getCountryByCodeName(expectedCountry.getCodeName());
